...
[`./Architecture.md`](./Architecture.md) for why this is one table
...
`./Architecture.md`) fixes this for good, not just for the specific
...
[`./Architecture.md`](./Architecture.md)を参照。フロントエンドは
...
`./Architecture.md`のDynamoDBの節を参照）ことで、発覚した特定の
